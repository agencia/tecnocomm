...
if ((isset($_POST['id'])) && ($_POST['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM herramienta WHERE id=%s",
...
mysql_select_db($database_tecnocomm, $tecnocomm);
$query_Rs = sprintf("SELECT * FROM herramienta WHERE id = %s", GetSQLValueString($colname_Rs, "int"));
...
<table width="350" border="0" align="center" class="wrapper">
  ...
  <tr>
    <td>&nbsp;</td>
    <td>ESTAS SEGURO QUE DESEAS ELIMINAR LA HERRAMIENTA:<span class="Estilo1"><?php echo $row_Rs['descripcion']; ?></span>?</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
