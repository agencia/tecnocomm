...
$query_rsTarea = sprintf("SELECT * FROM tarea WHERE idip = %s and respuesta is not NULL", GetSQLValueString($colname_rsTarea, "int"));
...
?>
      ...
      <td>
        <?php $comentarios = json_decode($row_rsTarea['respuesta'],true); ?>
        <?php 
