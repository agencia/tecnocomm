...
if(isset($_GET['buscar']) and ($_GET['buscar']!="")){
	$sql.=" where nombre like ".GetSQLValueString("%".$_GET['buscar']."%","text");
...
<body class="wrapper">
<table  border="0" cellpadding="0" cellspacing="0" class="resaltarTabla" width="100%">
      <!--DWLayoutTable-->
      <tr class="titleTabla">
          ...
          <td colspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <?php do { ?>
                <tr>
                  ...
                  <td width="99" valign="top"><a href="facturandoAgregarConceptoCantidad.php?idfactura=<?php echo $_GET['idfactura'];?>&idarticulo=<?php echo $row_RsArticulos['idarticulo']; ?>"><img src="images/Checkmark.png" width="24" height="24" /></a></td>
                </tr>
