...
if((isset($_SESSION['subcoti']))and ($_SESSION['subcoti']!=-1)){$subcoti=$_SESSION['subcoti'];}else{$subcoti=$_GET['idsubcotizacion'];}
...
<table width="1036" border="0" align="center">
  <tr class="titulos">
    <td colspan="6" align="center" class="Estilo1" >AGREGAR ARTICULOS A COTIZACION</td>
    </tr>
  <tr>
    <td width="100">&nbsp;</td>
    <td colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="2">&nbsp;</td>
    <td colspan="3" align="center"><a href="nuevoProducto.php" onclick="NewWindow(this.href,'modificar articulo','500','500','no');return false"><img src="images/Agregar.png" width="24" height="24" border="0" align="middle" title="AGREGAR NUEVO ARTICULO" />AGREGAR ARTICULO</a></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php if ($totalRows_RsArticulos > 0) { // Show if recordset not empty ?>
<a href="nuevaPartidaExtra.php?idart=<?php echo $row_RsArticulos['idarticulo'];?>&idsubcotizacion=<?php echo $subcoti;?>" onclick="NewWindow(this.href,'Agregar articulo','600','500','no');return false"> <img src="images/Checkmark.png" alt="agregar" border="0" title="AGREGAR ARTICULO A COTIZACION" /></a>
...
<input type="hidden" name="idsubcotizacion" value="<?php echo $subcoti;?>"/>
