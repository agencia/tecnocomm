...
mysql_select_db($database_tecnocomm, $tecnocomm);
$query_rsDetalle = sprintf("SELECT *, sb.moneda AS monedacotizacion FROM subcotizacionarticulo sb, articulo a WHERE idsubcotizacion = %s AND a.idarticulo = sb.idarticulo ORDER BY sb.idsubcotizacionarticulo ASC", GetSQLValueString($colname_rsDetalle, "int"));
