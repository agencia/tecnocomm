...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE subcotizacion SET utilidad_global=%s WHERE idsubcotizacion=%s",
  ...
  $Result1 = mysql_query($updateSQL, $tecnocomm) or die(mysql_error());
   ...
   $updateSQL1 = sprintf("UPDATE subcotizacionarticulo SET utilidad=%s WHERE idsubcotizacion=%s",
                       GetSQLValueString($_POST['textfield'], "double"),
                       GetSQLValueString($_POST['idsub'], "int"));

  mysql_select_db($database_tecnocomm, $tecnocomm);
  $Result12 = mysql_query($updateSQL1, $tecnocomm) or die(mysql_error());
...
<table width="400" border="0" align="center" class="wrapper">
  <tr>
    <td colspan="3" align="center" class="titulos">CAMBIAR FACTOR DE UTILIDAD</td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3" align="center">FACTOR DE UTILIDAD:
    
      <label>
          <input type="text" name="textfield" id="textfield" value="<?php echo $row_rsSub['utilidad_global']?>" />
        </label>    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
