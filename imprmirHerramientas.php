...
function titulo(){
	$this->SetFont('Arial','B',6);
	$this->Cell(190,3,'LISTA DE HERRAMIENTAS DE TECNOCOMM',0);
	$this->Ln();
...
$query_rsProducto = "SELECT * FROM herramienta ORDER BY nombre ASC";
...
do{
	...
	$data[$i][8] = utf8_decode($row_rsProducto['ubicacion']);
...
$header=array('Id','Marca','Modelo','Descripcion','Num.Serie','F.Compra','Proveedor','V.Contable','Ubicacion');
