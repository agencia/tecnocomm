...
mysql_select_db($database_tecnocomm, $tecnocomm);
$query_RsNumCotizacion = "SELECT max(identificador) as sig,  EXTRACT(YEAR FROM fecha) FROM subcotizacion WHERE identificador2 not like 'C-%-08%' AND EXTRACT(YEAR FROM DATE(fecha)) = EXTRACT(YEAR FROM DATE(NOW())) GROUP BY  EXTRACT(YEAR FROM DATE(fecha)) order by  EXTRACT(YEAR FROM fecha) DESC";
...
<table width="800" border="0" align="center">
  ...
  <tr>
    ...
    <td><select name="idcliente" class="form" id="idcliente">
...
?>
    </select><a href="nuevoCliente.php" onclick="NewWindow(this.href,'NUevo Cliente','500','500','yes');return false"><img src="images/AddUser.png" alt="Agregar Usuario" width="24" height="24" border="0" title="AGREGAR NUEVO CLIENTE" align="absmiddle"/></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
