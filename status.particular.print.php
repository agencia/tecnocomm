...
do {
	 ...
	 if(is_array($cotizaciones[$row_rsCotizaciones['idsubcotizacion']]) ) if(in_array($_SESSION['MM_Username'],$cotizaciones[$row_rsCotizaciones['idsubcotizacion']]) ):
...
if(is_array($levantamientos[$row_rsLevantamientos['idlevantamientoip']]) ) if(in_array($_SESSION['MM_Username'],$levantamientos[$row_rsLevantamientos['idlevantamientoip']]) ):
...
if(is_array($ordenes[$row_rsOrdenes['idordenservicio']]) ) if(in_array($_SESSION['MM_Username'],$ordenes[$row_rsOrdenes['idordenservicio']]) ):
...
$pdf->Row(array('IP','Factura','Cliente','Concepto','Responsable'));
 ...
 if(is_array($facturas[$row_rsFacturas['idfactura']]) ) if(in_array($_SESSION['MM_Username'],$facturas[$row_rsFacturas['idfactura']]) ):
