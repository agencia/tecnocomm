...
$pdf->setPie(format_money($subtotal),format_money($subtotal*.15),format_money(($subtotal*1.15)),utf8_decode($row_rsFirma['nombrereal']),utf8_decode($row_rsFirma['puesto']),utf8_decode($row_rsFirma['email']),utf8_decode($row_rsOrdenCompra['formapago']),utf8_decode($moneda[$row_rsOrdenCompra['moneda']]),utf8_decode($row_rsOrdenCompra['vigencia']),utf8_decode($row_rsOrdenCompra['tiempoentrega']),utf8_decode($row_rsOrdenCompra['descuento']),utf8_decode($row_rsOrdenCompra['notas']));
...
$pdf->Output($row_rsOrdenCompra['identificador'].'.pdf','D');
