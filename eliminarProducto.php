...
if (isset($_GET['idarticulo'])) {
  $ide_RsCliente = $_GET['idarticulo'];
}
mysql_select_db($database_tecnocomm, $tecnocomm);
$query_RsCliente = sprintf("select * from articulo where idarticulo=%s", GetSQLValueString($ide_RsCliente, "int"));
...
<table width="350" border="0" align="center" class="wrapper">
  ...
  <tr>
    <td>&nbsp;</td>
    <td>ESTAS SEGURO QUE DESEAS ELIMINAR ESTE PRODUCTO:<span class="Estilo1"><?php echo $row_RsCliente['nombre']; ?></span>?</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
