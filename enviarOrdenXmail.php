...
<table width="841" border="0" cellpadding="0" cellspacing="0" class="wrapper resaltarTabla" align="center">
  <!--DWLayoutTable-->
  <tr>
    <td height="28" colspan="12" valign="top" class="titulos">ENVIAR ORDEN DE COMPRA</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="20"></td>
    <td colspan="3" valign="top">ORDEN DE COMPRA:</td>
  ...
  <tr>
    ...
    <td colspan="4" valign="top"><label>
      <input name="asunto" type="text" id="asunto" value="ORDEN DE COMPRA: <?php echo htmlentities($row_rsCotizacion['identificador']); ?>" size="45"/>
    </label></td>
    <td></td>
    <td></td>
    <td></td>
  ...
  <tr>
    <td height="20"></td>
    <td colspan="9" valign="top">NOTA: LA ORDEN DE COMPRA SE ADJUNTARA AUTOMATICAMENTE.</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
