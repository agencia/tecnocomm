...
<table width="1036" border="0" align="center">
  <tr class="titulos">
    <td colspan="7" align="center" class="Estilo1" >AGREGAR ARTICULOS A ORDEN DE SERVICIO</td>
    </tr>
  <tr>
    <td width="100">&nbsp;</td>
    <td colspan="2">&nbsp;</td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php if ($totalRows_RsArticulos > 0) { // Show if recordset not empty ?>
<a href="nuevo.orden.agregar.php?idarticulo=<?php echo $row_RsArticulos['idarticulo'];?>&idordenservicio=<?php echo $_GET["idordenservicio"];?>" onclick="NewWindow(this.href,'Agregar articulo','600','500','no');return false"> <img src="images/Checkmark.png" alt="agregar" border="0" title="AGREGAR ARTICULO A ORDEN DE SERVICIO" /></a>
