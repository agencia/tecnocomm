...
if(isset($_GET['opc']) && $_GET['opc'] == "add"){
	
mysql_select_db($database_tecnocomm, $tecnocomm);
	$query = sprintf("INSERT INTO proyecto_herramienta(idip,idherramienta) VALUES(%s,%s,NOW())",
						  GetSQLValueString($_GET['idip'],"int"),
						  GetSQLValueString($_GET['idh'],"int"));
	$result = mysql_query($query,$tecnocomm) or die (mysql_error());
}
...
<tbody>
  <?php do { ?>
    ...
    <td><?php echo $row_rsHerramienta['modelo']; ?></td>
      ...
      <td><a href="herramienta.salida.php?opc=add&idh=<?php echo $row_rsHerramienta['id']; ?>&idip=<?php echo $_GET['idip']; ?>" class="popup"><img src="images/state3.png" border="none"></a></td>
      </tr>
