...
<option  value="-1" <?php if($_GET['estado'] == -1 || !isset($_GET['estado']) ){echo "selected=\"selected\"";}?>>Todos</option>
<option value="0" <?php if(isset($_GET['estado']) && $_GET['estado'] == 0 ){echo "selected=\"selected\"";}?>>Abiertos</option>
<option value="1" <?php if(isset($_GET['estado']) && $_GET['estado'] == 1 ){echo "selected=\"selected\"";}?>>En Proceso</option>
<option value="2" <?php if(isset($_GET['estado']) && $_GET['estado'] == 2 ){echo "selected=\"selected\"";}?>>Cerrado</option>
</select>
</label>
<br />
<label>
