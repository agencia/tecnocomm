...
$query_rsCotizacion = sprintf("SELECT c.idip, sb.idsubcotizacion, sb.identificador2, cc.nombre,cc.correo FROM subcotizacion sb,contactoclientes cc, cotizacion c WHERE c.idcotizacion = sb.idcotizacion AND idsubcotizacion = %s AND sb.contacto = cc.idcontacto", GetSQLValueString($colname_rsCotizacion, "int"));
...
<body>
<div id="contenido">
<form name="enviarmail" id="enviarmail" method="post" action="enviarcorreo.php">
<table width="841" border="0" cellpadding="0" cellspacing="0" class="wrapper resaltarTabla" align="center">
  ...
  <tr>
    ...
    <td colspan="3" valign="top"><?php echo $row_rsCotizacion['identificador2']; ?></td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
  ...
  <tr>
    <td height="20"></td>
    <td colspan="4" valign="top"><?php echo $row_rsCotizacion['nombre']; ?></td>
    <td></td>
  ...
  <tr>
    <td height="20"></td>
    <td colspan="4" valign="top"><?php echo $row_rsCotizacion['correo']; ?></td>
    <td></td>
  ...
  <tr>
    ...
    <td colspan="4" valign="top"><label>
      <input name="asunto" type="text" id="asunto" value="COTIZACION: <?php echo htmlentities($row_rsCotizacion['identificador2']); ?> (IP: <?php echo $row_rsCotizacion['idip']; ?>)" size="45"/>
    </label></td>
    <td></td>
    <td></td>
    <td></td>
