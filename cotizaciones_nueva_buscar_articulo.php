...
<table width="1036" border="0" align="center">
  <tr class="titulos">
    <td colspan="7" align="center" class="Estilo1" >AGREGAR ARTICULOS A COTIZACION</td>
    </tr>
  <tr>
    <td width="100">&nbsp;</td>
    <td colspan="2">&nbsp;</td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php if ($totalRows_RsArticulos > 0) { // Show if recordset not empty ?>
<a href="cotizaciones_nueva_agregar_articulo.php?idarticulo=<?php echo $row_RsArticulos['idarticulo'];?>&idsubcotizacion=<?php echo $subcoti;?>&tipo=<?php echo $_GET['tipo'];?>&cambio=<?php echo $_GET['cambio'];?>" onclick="NewWindow(this.href,'Agregar articulo','600','500','no');return false"> <img src="images/Checkmark.png" alt="agregar" border="0" title="AGREGAR ARTICULO A COTIZACION" /></a>
...
<input type="hidden" name="cambio" value="<?php echo $_GET['cambio'];?>"/>
</form>
</body>
</html>
<?php
