...
if(isset($_GET['buscar']) && $_GET['buscar']!=""){
	$query = sprintf("SELECT * FROM articulo WHERE nombre like %s",GetSQLValueString("%".$_GET['buscar']."%","text"));
}else{
...
<thead>
<tr><td colspan="3" align="right"><table border="0">
  <tr>
...
<tbody>
  <?php do { ?>
    <tr>
      ...
      <td><a href="requesicionmaterial.extra.ok.php?idip=<?php echo $_GET['idip'];?>&idarticulo=<?php echo $row_rsArticulos['idarticulo']; ?>" class="popup"><img src="images/Checkmark.png"  border="0"/></a></td>
    </tr>
