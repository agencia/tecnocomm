...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE ip SET estado=%s WHERE idip=%s",
...
<div>
<h3>Confirmacion</h3>
Deseas finalizar este Proyecto?
<div class="botones">
<button name="aceptar" type="submit" class="button"><span>Finalizar</span></button>
</div>
</div>
