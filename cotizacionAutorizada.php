...
<table width="400" border="0" align="center" class="wrapper">
  <tr class="titulos">
    <td colspan="4" align="center">AUTORIZAR COTIZACION</td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="4" align="center">DESEAS CAMBIAR DE ESTADO LA COTIZACION <span class="Estilo1"><?php echo $row_RsSub['identificador2']; ?></span>(<span class="Estilo1"><?php echo $row_RsSub['nombre']; ?></span>)A AUTORIZADA?</td>
    </tr>
