...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "addLevant")) {
  $insertSQL = sprintf("INSERT INTO proyecto_salida (idproyecto, idarticulo, tipo, cantidad, fecha, hora, observaciones, extra) VALUES (%s, %s, 2, %s, NOW(), NOW(), %s, 1)",
...
<label>
Observaciones:
<textarea name="observacioens"></textarea>
</label>
</div>
<div id="botones">
