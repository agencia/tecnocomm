...
<table width="400" border="0" align="center" class="wrapper">
  <tr class="titulos">
    <td colspan="4" align="center">TERMINAR COTIZACION</td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="4" align="center">DESEAS DAR POR TERMINADA LA COTIZACION <span class="Estilo1"><?php echo $row_RsSub['identificador2']; ?></span>(<span class="Estilo1"><?php echo $row_RsSub['nombre']; ?></span>)?<BR />(TERMINADA SIGNIFICA QUE FUE AUTORIZADA Y SE COMENZO A TRABAJAR EN ELLA)</td>
    </tr>
