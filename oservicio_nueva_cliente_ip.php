...
<table width="800" border="0" align="center">
  <tr>
    <td width="1">&nbsp;</td>
    <td colspan="3" align="center" class="titulos" background="images/titulo.gif">NUEVA ORDEN DE SERVICIO</td>
...
<?php  } ?>
  <tr>
    ...
    <td><input name="identificador" type="text" class="form" id="nombre" size="40" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<!--  <tr>
  ...
  <tr>
    ...
    <td><input name="textfield" type="text" class="form" id="textfield" value="<?php echo $row_RsNumOrden['numeroorden'] + 1; ?>" size="6" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" align="right" valign="top">DESCRIPCION DEL REPORTE:<br /></td>
    <td><textarea name="descripcionreporte">
  </textarea> </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" align="right" valign="top">OBSERVACIONES:<br /></td>
    <td>
