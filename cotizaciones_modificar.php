...
<table width="1180" border="0" align="center" >
  ...
  <tr>
    ...
    <td colspan="9" align="center" class="titulos">MODIFICAR COTIZACION</td>
  </tr>
...
<fieldset><legend>DATOS CLIENTE</legend>
  ...
  <tr>
    ...
    <td colspan="4" align="right"><a href="cotizaciones_nueva_buscar_articulo.php?idsubcotizacion=<?php echo $_GET['idsubcotizacion'];?>&tipo=<?php echo $row_RsSub['tipo'];$_SESSION['subcoti']=-1?>&cambio=<?php echo $row_RsSub['tipo_cambio'];?>" onclick="NewWindow(this.href,'Buscar articulo','1100','800','yes');return false"><img src="images/AddTask.gif" alt="Agregar" width="24" height="24" border="0" align="middle" />AGREGAR </a></td>
  </tr>

  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="3"><a href="exportarExcel.php?query=<?php echo $query_RsArticulos; ?>" onclick="NewWindow(this.href,'Ver Partida Extra',600,800,'yes'); return false;"><img src="images/Agregar.png" alt="" width="24" height="24" border="0" align="middle" title="CARGAR DATOS DE AVANCE" />EXPORTAR A EXCEL</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="9"><form id="form1" name="form1" method="get" action="<?php echo $editFormAction; ?>">
      <label>Buscar
  ...
  <?php if ($totalRows_RsArticulos > 0) { // Show if recordset not empty ?>
    ...
    <tr class="titleTabla">
      ...
      <td width="98" align="center">OPCIONES</td>
      <td width="117" align="center">INFO</td>
    </tr>
...
//echo $row_RsSub['tipo']."-->".$manoobra."*".$row_RsArticulos['cantidad']."=".$mo;
...
<?php } // Show if recordset not empty ?>
    ...
    <?php if ($totalRows_RsArticulos == 0) { // Show if recordset empty ?>
      ...
      <?php if ($totalRows_RsArticulos > 0 and $row_RsSub['tipo']==1) { // Show if recordset not empty ?>
          ...
          <tr>
            <td colspan="7" align="right"><a href="modificarMO.php?idsubcotizacion=<?php echo $_GET['idsubcotizacion'];?>&cant= <?php echo money_format('%i',$mano*$row_RsMO['monto']); ?>" onclick="NewWindow(this.href,'Buscar articulo','400','250','yes');return false"><?php echo $row_RsMO['descrimano']; ?>:</a></td>
            <td colspan="2" align="left">+$<?php echo money_format('%i',$mano*$row_RsMO['monto']*$row_RsMO['cantidad']); ?></td>
          </tr> 
