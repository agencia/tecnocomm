...
{
	$buscar = "AND c.nombre like '%%".$_GET['buscar']."%%'";
	$filtro = $_GET['buscar'];
}
if(isset($_GET['estado']) and $_GET['estado'] != -1)
{
	$estado = " AND f.estado = ".$_GET['estado'];
	$filtro1 = $_GET['estado'];
}else 
{
	$filtro1 = -1;
...
<div id="opciones">
<a href="cuentasxcobrar.reporte.pdf.php?filtro=<?php echo $filtro; ?>&filtro1=<?php echo $filtro1; ?>" class="popup"><img src="images/Imprimir2.png" border="0" title="Imprimir" width="24" height="24"/>Imprimir</a>
</div>
...
<thead>
<tr><td width="20%">Estado</td><td width="10%">No Factura</td><td width="10%">IP</td><td width="20%">Fecha</td><td width="20%">Monto</td><td width="20%">Vence En</td></tr>
</thead>
<tbody>
