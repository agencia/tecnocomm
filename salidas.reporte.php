...
<p>Muestra una lista del material que ha salido de almacen, para registrar una nueva salida de click en Registrar Salida o bien si Registrar Salida Con Escanner</p>
<div id="opciones">
<ul>
<li><a href="salida.php?idip?<?php echo $_GET['idip']; ?>" class="popup">Registrar Salida</a></li>
<li><a href="salida.php?idip?<?php echo $_GET['idip']; ?>" class="popup">Registrar Salida (Modo Escanner)</a></li>
</ul>
</div>
<div id="distabla">
